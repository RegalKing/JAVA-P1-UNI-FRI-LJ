...
public class Druga { 
    ...
    public static int potZoge(int strelec, boolean[][] igralci, int smer) {
        int sredina=(igralci.length/2); // avtomatsko zaokrozi igralci.length/2 na zeljeno sredino ker imamo tip int
        int razdalja=0;
        int doGola= smer==1 ? igralci[0].length-strelec-1: strelec; // razdalja od zoge do gola na zeljeni strani glede na smer
        boolean found=false;
