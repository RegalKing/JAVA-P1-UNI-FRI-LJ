...
public class Test12 {
    ...
    public static void main(String[] args) {
        ...
        prehodi.get("q0").put('b', "q2");
        prehodi.get("q0").put('c', "q1");
        prehodi.get("q0").put('d', "q11");
        prehodi.get("q1").put('b', "q11");
        prehodi.get("q1").put('c', "q12");
