...
public class Test25 {
    ...
    public static void main(String[] args) {
        ...
        prehodi.get("q11").put('c', "q13");
        prehodi.get("q11").put('d', "q18");
        prehodi.get("q12").put('b', "q9");
        prehodi.get("q12").put('c', "q16");
        ...
        prehodi.get("q14").put('a', "q11");
        prehodi.get("q14").put('b', "q7");
        prehodi.get("q14").put('c', "q4");
        prehodi.get("q14").put('d', "q9");
        prehodi.get("q15").put('a', "q1");
        prehodi.get("q15").put('b', "q18");
        prehodi.get("q15").put('c', "q3");
        prehodi.get("q15").put('d', "q10");
        prehodi.get("q16").put('a', "q0");
        prehodi.get("q16").put('b', "q4");
        prehodi.get("q16").put('c', "q16");
        prehodi.get("q16").put('d', "q3");
        prehodi.get("q17").put('a', "q10");
        prehodi.get("q17").put('b', "q6");
        prehodi.get("q17").put('c', "q19");
        prehodi.get("q17").put('d', "q1");
        prehodi.get("q18").put('a', "q11");
        prehodi.get("q18").put('b', "q15");
        prehodi.get("q18").put('c', "q16");
        prehodi.get("q18").put('d', "q13");
        prehodi.get("q19").put('b', "q16");
        prehodi.get("q19").put('c', "q14");
        prehodi.get("q19").put('d', "q3");

        Cetrta.Avtomat avtomat = new Cetrta.Avtomat(zacetno, sprejemna, prehodi);

        System.out.println(avtomat.kam("adccdc"));
        System.out.println(avtomat.kam("bbbacc"));
        System.out.println(avtomat.kam("aacbab"));
        System.out.println(avtomat.kam("dd"));
        System.out.println(avtomat.kam("badcd"));
        System.out.println(avtomat.kam("dabcb"));
        System.out.println(avtomat.kam("badba"));
        System.out.println(avtomat.kam("cbbbaa"));
        System.out.println(avtomat.kam("bdccab"));
        System.out.println(avtomat.kam("dcbab"));
        System.out.println(avtomat.kam("dddcb"));
        System.out.println(avtomat.kam("cbbdca"));
        System.out.println(avtomat.kam("caccb"));
        System.out.println(avtomat.kam("abdbc"));
        System.out.println(avtomat.kam("aadadc"));
        System.out.println(avtomat.kam("adcdbb"));
        System.out.println(avtomat.kam("cdadaa"));
    }
}
