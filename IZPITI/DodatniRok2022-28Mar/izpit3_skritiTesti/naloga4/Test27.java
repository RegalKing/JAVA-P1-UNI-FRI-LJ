...
public class Test27 {
    ...
    public static void main(String[] args) {
        ...
        prehodi.get("q0").put('a', "q17");
        prehodi.get("q0").put('b', "q8");
        prehodi.get("q0").put('c', "q12");
        prehodi.get("q0").put('d', "q1");
        ...
        prehodi.get("q14").put('d', "q16");
        prehodi.get("q15").put('a', "q0");
        prehodi.get("q15").put('b', "q12");
        prehodi.get("q15").put('c', "q3");
        prehodi.get("q15").put('d', "q6");
        prehodi.get("q16").put('a', "q0");
        prehodi.get("q16").put('b', "q5");
        prehodi.get("q16").put('c', "q4");
        prehodi.get("q16").put('d', "q9");
        prehodi.get("q17").put('a', "q12");
        prehodi.get("q17").put('b', "q9");
        prehodi.get("q17").put('c', "q2");
        prehodi.get("q17").put('d', "q11");
        prehodi.get("q18").put('a', "q13");
        ...
        System.out.println(avtomat.kam("cacbba"));
        System.out.println(avtomat.kam("acd"));
        System.out.println(avtomat.kam("cbaaab"));
        System.out.println(avtomat.kam("dbbaad"));
        System.out.println(avtomat.kam("dacbbd"));
        System.out.println(avtomat.kam("aacdd"));
        System.out.println(avtomat.kam("aabaaa"));
        System.out.println(avtomat.kam("dcbca"));
        System.out.println(avtomat.kam("cdadb"));
        System.out.println(avtomat.kam("cdbdcd"));
        System.out.println(avtomat.kam("dcdadc"));
        System.out.println(avtomat.kam("caaabc"));
        System.out.println(avtomat.kam("cbdacc"));
        System.out.println(avtomat.kam("dcabbb"));
        System.out.println(avtomat.kam("abadcc"));
    }
}
