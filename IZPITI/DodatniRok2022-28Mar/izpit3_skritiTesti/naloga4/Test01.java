...
public class Test01 {
    ...
    public static void main(String[] args) {
        ...
        prehodi.get("q1").put('b', "q14");
        prehodi.get("q1").put('c', "q15");
        prehodi.get("q2").put('a', "q9");
        prehodi.get("q2").put('b', "q12");
        prehodi.get("q2").put('d', "q10");
        prehodi.get("q3").put('a', "q1");
        prehodi.get("q3").put('c', "q6");
        prehodi.get("q4").put('c', "q12");
        prehodi.get("q5").put('b', "q15");
        prehodi.get("q5").put('d', "q3");
        prehodi.get("q6").put('d', "q1");
        prehodi.get("q7").put('a', "q14");
        prehodi.get("q7").put('b', "q8");
        prehodi.get("q7").put('c', "q15");
        prehodi.get("q8").put('a', "q11");
        prehodi.get("q8").put('b', "q7");
        prehodi.get("q8").put('d', "q4");
        prehodi.get("q9").put('b', "q0");
        prehodi.get("q9").put('d', "q4");
        prehodi.get("q10").put('b', "q0");
        prehodi.get("q10").put('c', "q5");
        prehodi.get("q12").put('a', "q7");
        prehodi.get("q12").put('c', "q15");
        prehodi.get("q12").put('d', "q5");
        prehodi.get("q13").put('a', "q5");
        prehodi.get("q13").put('b', "q2");
        prehodi.get("q14").put('a', "q5");
        prehodi.get("q14").put('b', "q9");
        prehodi.get("q15").put('a', "q11");
        prehodi.get("q15").put('d', "q16");
        prehodi.get("q16").put('a', "q9");
        prehodi.get("q16").put('c', "q11");
        prehodi.get("q16").put('d', "q3");
