...
public class Test02 {
    ...
    public static void main(String[] args) {
        ...
        prehodi.get("q15").put('c', "q4");
        prehodi.get("q15").put('d', "q6");
        prehodi.get("q16").put('a', "q18");
        prehodi.get("q16").put('b', "q11");
        prehodi.get("q16").put('c', "q2");
        prehodi.get("q16").put('d', "q7");
        prehodi.get("q17").put('a', "q13");
        prehodi.get("q17").put('b', "q4");
        prehodi.get("q17").put('c', "q6");
        prehodi.get("q17").put('d', "q10");
        prehodi.get("q18").put('a', "q15");
        prehodi.get("q18").put('b', "q13");
        prehodi.get("q18").put('c', "q3");
