...
public class Test06 {
    ...
    public static void main(String[] args) {
        ...
        prehodi.get("q2").put('c', "q1");
        prehodi.get("q2").put('d', "q4");
        ...
        prehodi.get("q5").put('b', "q5");
        prehodi.get("q5").put('c', "q6");
        prehodi.get("q5").put('d', "q11");
        ...
        prehodi.get("q8").put('d', "q9");
        prehodi.get("q9").put('a', "q10");
