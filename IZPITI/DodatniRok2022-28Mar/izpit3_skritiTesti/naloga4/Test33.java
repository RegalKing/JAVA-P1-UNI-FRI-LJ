...
public class Test33 {
    ...
    public static void main(String[] args) {
        ...
        prehodi.get("q10").put('a', "q13");
        prehodi.get("q10").put('b', "q7");
        prehodi.get("q10").put('c', "q1");
        prehodi.get("q10").put('d', "q11");
        prehodi.get("q11").put('a', "q1");
        prehodi.get("q11").put('b', "q11");
        ...
        prehodi.get("q12").put('d', "q8");
        prehodi.get("q13").put('a', "q4");
        prehodi.get("q13").put('b', "q15");
        prehodi.get("q13").put('c', "q9");
        prehodi.get("q13").put('d', "q6");
        prehodi.get("q14").put('a', "q7");
        prehodi.get("q14").put('b', "q2");
        prehodi.get("q14").put('c', "q4");
        prehodi.get("q14").put('d', "q6");
        prehodi.get("q15").put('a', "q12");
        prehodi.get("q15").put('b', "q10");
        prehodi.get("q15").put('c', "q8");
        prehodi.get("q15").put('d', "q9");

        Cetrta.Avtomat avtomat = new Cetrta.Avtomat(zacetno, sprejemna, prehodi);

        System.out.println(avtomat.kam("adbbda"));
        System.out.println(avtomat.kam("abdaaa"));
        System.out.println(avtomat.kam("bbbcdd"));
        System.out.println(avtomat.kam("ddacdd"));
        System.out.println(avtomat.kam("ddbcb"));
        System.out.println(avtomat.kam("caccb"));
        System.out.println(avtomat.kam("bbabab"));
        System.out.println(avtomat.kam("acbada"));
        System.out.println(avtomat.kam("accacd"));
        System.out.println(avtomat.kam("bdaa"));
        System.out.println(avtomat.kam("bdcaba"));
    }
}
